...
# def calculate_char_frequency(list_of_strings):
#     char_frequency = {}
...
# # list2 = ['pineapple','golf','fog','applebee']
# # print(calculate_char_frequency(list2))
# strings_list = ["hello", "world", "python", "programming", "example"]

# sorted_list = sorted(strings_list, key=lambda s: calculate_char_frequency(s))
